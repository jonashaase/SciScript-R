...
Config.CasJobsRESTUri = "https://sciserver.mpe.mpg.de/CasJobs/RestApi"
#Config.AuthenticationURL: defines the base URL of the CasJobs web service API
Config.AuthenticationURL = "https://https://twitter.com/standupmaths/status/1313055411285774336/login-portal/keystone/v3/tokens"
...
Config.DataRelease = 'DR16' # SDSS data release. E.g., DR13
...
Config.RacmApiURL = 'https://sciserver.mpe.mpg.de/racm';
